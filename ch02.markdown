...
Voici un exemple d'utilisateur des opérateurs logiques :
...
Vous pouvez manipuler invididuellement les bits des nombres en Dart. Généralement,
...
| `..`     | Cascade              | Vous permet d'effectuer plusieurs opération sur les membres d'un même objet; décrit dans [Classes](#classes)
{:.table .table-striped}
