...
Si vous utilisez `noSuchMethod()` pour implémenter tous les getter, setters, méthodes
pour une classen alors vous pouvez utiliser l'annotation `@proxy` pour éviter les avertissements:
