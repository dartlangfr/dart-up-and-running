...
déjà programmer dans un autre langage.

<aside class="alert alert-info" markdown="1">
**Note:**
Vous pouvez essayer la plupart des fonctionnalités présentées dans [Up and running](ch01.html#up-and-running) en utilisant 
...
:   La fonction spéciale de premier niveau, nécessaire, par où l’application démarre.
...
<aside class="alert alert-info" markdown="1">
**Note:**
Notre code suit la convention décrite dans le [Dart Style
...
-   Contrairement à Java, Dart n'a pas les mots-clés `public`,
    ...
    voir [Bibliothèques et visibilité](#libraries-and-visibility).
...
<aside class="alert alert-info" markdown="1">
**Note:**
Ce chapitre suit la [convention de code](https://www.dartlang.org/articles/style-guide/#type-annotations)
...
Pour plus d'information sur les listes, voir les [Génériques](#generics) et
les [Collections](ch03.html#collections).
...
Voici quelques exemples simples de dictionnaire en Dart, créés en
...
Pour plus d'information sur les dictionnaires, voir les
[Génériques](#generics) et
[Maps](ch03.html#maps).
...
comme instanciable, définissez un [Constructeur de type fabrique](#factory-constructors).
...
Dart.](https://www.dartlang.org/articles/mixins/)
...
Dart.](https://www.dartlang.org/articles/optional-types/)
...
Voir [Pub Package and Asset Manager](https://www.dartlang.org/tools/pub/)
...
see [Support de l'asynchronisme](#asynchrony).
...
and the [Dart language specification](https://www.dartlang.org/docs/spec/).
...
documentation.](https://www.dartlang.org/tools/dartdocgen/) du SDK. Pour un exemple de 
documentation générée, voir la [Documentation de l'API 
Dart.](http://api.dartlang.org). Pour des conseils sur la structuration 
des commentaires, voir le [Guide pour les commentaires de documentation 
Dart.](https://www.dartlang.org/articles/doc-comment-guidelines/)
...
d'information, voir la [Spécification du Langage Dart](https://www.dartlang.org/docs/spec/) et
les [articles](https://www.dartlang.org/articles/) tel que [Idiomatic
Dart.](https://www.dartlang.org/articles/idiomatic-dart/)
