...
La forme la plus commune de constructor, le constructeur générateur, créé
...
#### Invoquer un constructeur pas par défaut d'une superclasse {#invoking-a-non-default-superclass-constructor}
{:.no_toc}
...
Hormis l'invocation du constructeur de la class parente, vous pouvez
...
#### Constructeurs constants {#constant-constructors}
{:.no_toc}

Si votre classe produit des objets qui ne changent jamais, vous faire de
