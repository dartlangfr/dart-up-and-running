...
Les variables statiques (variables de classes) font utiles pour class-wide state et
constantes :
...
class Couleur {
  ...
  const Couleur(this.nom);                // Une constructeur de constantes.
}
...
Les variables statiques ne sont pas initialisées jusqu'à ce qu'elles soit utilisées.

<aside class="alert alert-info" markdown="1">
**Note:**
Ce chapitre suit le guide de style recommandé [style guide–
...
<aside class="alert alert-info" markdown="1">
**Note:**
Préférez l'utilisation de méthodes de haut niveau à des méthodes statiques, pour des fonctionnalités 
communes et largement utilisées.
</aside>
